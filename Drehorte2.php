...
while($row=$res->fetch_array())
{
 ?>
    ...
    <td><a href="?edit=<?php echo $row['id']; ?>" onclick="return confirm('Sicher editieren?'); " >Bearbeiten</a></td>
    <td><a href="?del=<?php echo $row['id']; ?>" onclick="return confirm('Sicher löschen?'); " >Löschen</a></td>
    </tr>
    <?php
}
